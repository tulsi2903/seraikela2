...
<div class="card">
    ...
    <div class="card-body">
        ...
        <!-- View Div -->
        <div id="toggle_div" style="display: none;border: 1px solid rgb(206, 206, 206); border-radius: 5px;padding: 15px; background: linear-gradient(to top, #a5baef, #ffffff 70%, #ffffff, #ffffff 100%); margin: 15px 0 15px 0;">
