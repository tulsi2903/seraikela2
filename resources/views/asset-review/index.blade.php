   ...
   <div class="container-fluid"> 
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-4">
                <div class="card">
                    <h4 class="card-header">Blocks</h4>
                    <div class="card-body">
                        <!-- <div class="form-group">    
                            <label>Review For<span style="color:red;margin-left:5px;">*</span></label><br/>
                            <label class="btn btn-outline-primary rounded-pill review-for-buttons" for="review-for-block" style="cursor: pointer;">Block</label>
                            ...
                            <input type="radio" id="review-for-block" name="review-for" value="block" hidden>
                            <input type="radio" id="review-for-panchayat" name="review-for" value="panchayat" hidden>
                            <hr/>
                        </div> -->
                        <div class="row">
                            <div class="col-6">
            ...
            <div class="col-lg-7 col-md-8">      
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item"><a class="nav-link active" id="tabular-tab" data-toggle="tab" href="#tabular-view-tab" role="tab" aria-selected="true">Tabular View</a></li>
                    <li class="nav-item"><a class="nav-link" id="graphical-tab" data-toggle="tab" href="#graphical-view-tab" role="tab" aria-selected="false">Graphical View</a></li>
                    <li class="nav-item"><a class="nav-link" id="map-tab" data-toggle="tab" href="#map-view-tab" role="tab" aria-selected="false">Map View</a></li>
                </ul>
                <div class="card">
                    <div class="card-body" style="min-height: 500px;">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="tabular-view-tab" role="tabpanel">
                                <h4>Tabular View &nbsp;<button type="button" class="btn btn-primary print-button" onclick="printReview('tabular')">Print&nbsp;&nbsp;<i class="fa fa-print" aria-hidden="true"></i></button></h4>
                                <div id="tabular-view">
                                </div>
                                <div class="no-data">
                            ...
                            <div class="tab-pane fade" id="graphical-view-tab" role="tabpanel">
                                <h4>Graphical View&nbsp;<button type="button" class="btn btn-primary print-button" onclick="printReview('graphical')">Print&nbsp;&nbsp;<i class="fa fa-print" aria-hidden="true"></i></button></h4>
                            ...
                            <div class="tab-pane fade" id="map-view-tab" role="tabpanel">
                                <h4>Map View&nbsp;<button type="button" class="btn btn-primary print-button" onclick="printReview('map')">Print&nbsp;&nbsp;<i class="fa fa-print" aria-hidden="true"></i></button></h4>
                                <div id="map-view">
                                    <div class="map-view-form">
                                        <div class="row form-group">
                                            <div class="col-3">
                                                <label for="map-view-block">Select Block<span style="color:red;margin-left:5px;">*</span></label>
...
<script>
    ...
    function search(){
        ...
        if(!dept_id_error&&!year_id_error&&!geo_id_error){
    ...
    function  getDatas(){
        ...
        dept_id = $("#dept_id").val();
        year_id = $("#year_id").val();
        geo_id = $("#geo_id").val(); // string, convert in controller
        ...
        $.ajax({
            ...
            data: {'geo_id': geo_id, 'dept_id': dept_id, 'year_id': year_id},
            method: "GET",
    ...
    function mapSearch(){
        ...
        if(errorMapSearch==false){
            ...
            $.ajax({
                ...
                data: {'geo_id': mapViewBlock, 'asset_id': mapViewAsset, 'year_id': mapViewYear},
                method: "GET",
                contentType: 'application/json',
                dataType: "json",
                beforeSend: function(data){
