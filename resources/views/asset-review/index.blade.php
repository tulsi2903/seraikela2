        ...
        <div id="search-block">
            <div class="card-body">
                ...
                <div style="text-align: right">
                    <hr/>
                    &nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-dark" style="display: none;" id="cancel-search-button" onclick="closeSearch();"><i class="fas fa-search"></i>&nbsp;&nbsp;Cancel</button>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.response == "no_data") { // no data found
                    ...
                    $("#all-view-details").append(`<br/><a href="javascript:void();" onclick="showSearch()"><i class="fas fa-sync"></i>&nbsp;&nbsp;Change</a>`);
                }
                $(".custom-loader").fadeOut(300);
                $("#search-results-block").removeClass("active-search");
            }
