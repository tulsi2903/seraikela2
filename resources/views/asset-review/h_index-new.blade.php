        ...
        <div id="search-block">
            <div class="card-body">
                <div class="form-group">
                    <label class="btn btn-outline-primary active rounded-pill review-for-buttons" for="review-for-block" style="cursor: pointer;">{{$phrase->block}}</label>
                    <label class="btn btn-outline-primary rounded-pill review-for-buttons" for="review-for-panchayat" style="cursor: pointer;">{{$phrase->panchayat}}</label>
                ...
                <div class="form-group">
                    <hr />
                    <label for="">{{$phrase->block}}<span style="color:red;margin-left:5px;">*</span></label>
                ...
                <div style="text-align: right">
                    <hr/>
                    &nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-dark" style="display: none;" id="cancel-search-button" onclick="closeSearch();"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;{{$phrase->cancel}}</button>
                    <button type="button" class="btn btn-primary" onclick="search()"><i class="fas fa-search"></i>&nbsp;&nbsp;{{$phrase->search}}</button>
                </div>
            </div>
        </div>
        <!-- map selection ends -->
                ...
                <div style="overflow: hidden; border-bottom: 1px solid #dee2e6;padding-top:5px;">
                    <div style="display: iniline-block; width: 50%; float: left;">
                        <ul class="nav nav-tabs" id="myTab" role="tablist" style="border: none;">
                            <li class="nav-item">
                                <a class="nav-link active" id="tabular-tab" data-toggle="tab" href="#tabular-view-tab" role="tab" aria-selected="true"><i class="fas fa-table"></i>&nbsp;{{$phrase->tabular_view}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="map-tab" data-toggle="tab" href="#map-view-tab" role="tab" aria-selected="false"><i class="fas fa-map-marked-alt"></i>&nbsp;{{$phrase->map_view}}</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="tab-content mt-2 mb-3" id="myTabContent">
                    ...
                    <div class="tab-pane fade printable-area" id="graphical-view-tab" role="tabpanel">
                        ...
                        <div id="graphical-view">
                            <div style="background: #f5f5f5; max-width: 800px; margin: auto; text-align:center; padding: 20px; border-radius: 3px;">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.response == "no_data") { // no data found
                    ...
                    $("#all-view-details").html("<b>{{$phrase->department}}: </b>" + $("#dept_id option:selected").text());
                    $("#all-view-details").append("<br/><b>{{$phrase->year}}: </b>" + $("#year_id option:selected").text());
                    $("#all-view-details").append(`<br/><a href="javascript:void();" onclick="showSearch()"><i class="fas fa-sync"></i>&nbsp;&nbsp;{{$phrase->change}}</a>`);
                }
