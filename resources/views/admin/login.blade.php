...
<body style="background:#e8e7e7";>
    <div class="login box box--big" style="margin-top:11%;">
            <!-- form starts here  --> 
        <form class="cmxform form-horizontal tasi-form" id="loginForm" method="POST" action="{{url('login')}}" novalidate="novalidate">
            @csrf
           ...
           <div class="agile-field-txt">
            <label><i class="fa fa-user" aria-hidden="true"></i> Username </label>
                <input id="login" type="text" name="login" value="" placeholder="Username" required autofocus">
