        ...
        <div class="col-md-12">
                <div class="card-header">
                    <div class="card-head-row card-tools-still-right" style="background:#fff;">
                        <h4 class="card-title">{{$phrase->department}}</h4>
                        <div class="card-tools">
                            <button type="button" class="btn btn-icon btn-round btn-success" title="{{$phrase->send_email}}" data-target="#create-email" data-toggle="modal" ><i class="fa fa-envelope" aria-hidden="true"></i></button>
                            <button type="button" class="btn btn-icon btn-round btn-default" title="{{$phrase->print}}" id="print-button" onclick="printView();"><i class="fa fa-print" aria-hidden="true"></i></button>
                            <a href="{{url('department/export/excelURL')}}"><button type="button" title="{{$phrase->export_excel}}" class="btn btn-icon btn-round btn-success" ><i class="fas fa-file-excel"></i></button></a>
                            <a href="{{url('department/pdf/pdfURL')}}" target="_BLANK"><button type="button" title="{{$phrase->export_pdf}}" class="btn btn-icon btn-round btn-warning" ><i class="fas fa-file-export"></i></button></a>
                            <a href="{{url('department/changeView')}}" data-toggle="tooltip" title="{{$phrase->import_excel}}"><button type="button" class="btn btn-icon btn-round btn-warning" ><i class="fa fa-upload"></i></button></a>
