        ...
        <div class="card-header">
            <div class="card-head-row card-tools-still-right" style="background:#fff;">
                ...
                <div class="card-tools">
                    ...
                    <a href="{{url('asset/pdf/pdfURL')}}" data-toggle="tooltip" title="Export to PDF"><button type="button" class="btn btn-icon btn-round btn-warning"><i class="fas fa-file-export"></i></button></a>
                    ...
                    <table class="table table-datatable" id="printable-area">
                        ...
                        <tr>
                            ...
                            <td class="action-buttons">
                                <a href="{{url('asset/delete')}}/{{$data->asset_id}}" class="btn btn-danger btn-sm delete-button"><i class="fas fa-trash-alt"></i></a>
                                &nbsp;&nbsp;<a href="javascirpt:void();" onclick="editAssetAjax('{{$data->asset_id}}')" class="btn btn-secondary btn-sm"><i class="fas fa-edit"></i></a>
                            </td>
                        </tr>
                        @endforeach
                        @endif
