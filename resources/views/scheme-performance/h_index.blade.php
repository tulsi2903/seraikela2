        ...
        <div class="card-header">
            <div class="card-head-row card-tools-still-right" style="background:#fff;">
                ...
                <div class="card-tools">
                    <a href="{{url('scheme-geo-target')}}" class="btn btn-sm btn-secondary" style="float:right;"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;{{$phrase->back}}</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-secondary go-button" onclick="go()"><i class="fas fa-search"></i>&nbsp;&nbsp;{{$phrase->search}}</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="enter-datas-block">
                <button type="button" class="btn" style="margin-left:1.5%;background: #0f85e2!important;color:#fff;"><i class="fas fa-location-arrow"></i>&nbsp;&nbsp;{{$phrase->enter_datas}} </button>
                <div class="card-body" style="background: #f2f6ff; border: 1px solid #a5bbf6;margin-top: -18px;">
                    <div style="padding: 15px 0; overflow: hidden; color: black;">
                        ...
                        <span style="display: none;" id="excelformat">
                            ...
                            <button type="submit" class="btn btn-primary" onclick="location.href='\ scheme-performance/downloadFormat?scheme_id='+ document.getElementById('scheme_id').value+'&year_id={{$year_data->year_id}}&block_id={{$block_data->geo_id}}'"  style="float:right; background: #349601; color: white;" title="Download Excel Format"><i class="fas fa-file-import"></i>&nbsp;&nbsp;{{$phrase->export_excel}}</button>
                            <button type="submit" class="btn btn-primary" onclick="location.href='\ scheme-performance/viewimport?scheme_id='+ document.getElementById('scheme_id').value+'&year_id={{$year_data->year_id}}&block_id={{$block_data->geo_id}}'"  style="float:right; background: #349601; color: white;;margin-right: 10px;" title="Import Excel"><i class="fas fa-file-import"></i>&nbsp;&nbsp;{{$phrase->import}}</button>
                        </span>
                    </div>
