				...
				<li class="nav-item">
					...
					<div class="collapse" id="review">
						<ul class="nav nav-collapse">
							...
							<li class="nav-item"><a href="{{url('review/scheme')}}"><i class="fas fa-receipt"></i><p>{{$phrase->scheme_review}}  </p></a></li>
							@endif
							@if(array_key_exists("mod21", $desig_permissions))
							<li class="nav-item"><a href="{{url('review/group')}}"><i class="fas fa-receipt"></i><p>{{$phrase->group_review}} </p></a></li>
							@endif</ul>
					</div>
				</li>
