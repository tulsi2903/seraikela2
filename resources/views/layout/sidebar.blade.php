				...
				<li class="nav-item">
					...
					<div class="collapse" id="review">
						<ul class="nav nav-collapse">
							...
							<li class="nav-item"><a href="{{url('asset-review')}}"><i class="fas fa-comments"></i><p>{{$phrase->resource_review}} </p></a></li>
							@endif
							@if(array_key_exists("mod20", $desig_permissions))
							<li class="nav-item"><a href="{{url('scheme-review')}}"><i class="fas fa-comments"></i><p>{{$phrase->scheme_review}}</p></a></li>
							@endif
