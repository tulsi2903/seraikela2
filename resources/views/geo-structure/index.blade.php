                ...
                <div class="card-header">
                    <div class="card-head-row card-tools-still-right" style="background:#fff;">
                        ...
                        <div class="card-tools">
                            ...
                            <button  type="button" onclick="exportTrigger()" name="print" value="print_pdf" class="btn btn-icon btn-round btn-warning" ><i class="fas fa-file-export"></i></button>
                            <button  type="button" onclick="exportTriggerexcel()" name="print" value="excel_sheet" class="btn btn-icon btn-round btn-warning" ><i class="fas fa-file-excel"></i></button>
